...
public class Assets {
	...
	public static Texture mainMenu = new Texture(
			Gdx.files.internal("mainmenu.png"));
	public static Texture buttons = new Texture(
			Gdx.files.internal("buttons.png"));

	public static Texture numbers = new Texture(
			Gdx.files.internal("numbers.png"));
	public static Texture ready = new Texture(Gdx.files.internal("ready.png"));
	public static Texture pause = new Texture(
			Gdx.files.internal("pausemenu.png"));
	public static Texture gameOver = new Texture(
			Gdx.files.internal("gameover.png"));
	public static Texture headUp = new Texture(Gdx.files.internal("headup.png"));
	public static Texture headLeft = new Texture(
			Gdx.files.internal("headleft.png"));
	public static Texture headDown = new Texture(
			Gdx.files.internal("headdown.png"));
	public static Texture headRight = new Texture(
			Gdx.files.internal("headright.png"));
