...
public class LoadingScreen extends SerpScreen {
	...
	Preferences settings = Settings.snakeSettings;
	Preferences highscores = Settings.snakeHighscores;
	...
	public LoadingScreen(Game game, AssetManager assets) {
		...
		Gdx.app.log("LoadingScreen",
				"LoadingScreen(game, assets), this.assets: " + this.assets);
		this.assets = new AssetManager();
		Gdx.app.log("LoadingScreen",
				"LoadingScreen(game, assets), this.assets: " + this.assets);
		loadAssetManager();
		Gdx.app.log("LoadingScreen", "LoadingScreen(game, assets), assets: "
				+ assets);
		loadSettings();
		loadHighscores();
	}
