...
public class World {
	...
	static final int SCORE_INCREMENT = 15;
	...
	private int randomPoo = 10; // poo is placed when random nº in this range
								// is <= score
	...
	*/
	...
	public void placeStain() {
		for (int x = 0; x < WORLD_WIDTH; x++) {
			for (int y = 2; y < WORLD_HEIGHT; y++) {
				fields[x][y] = false; // 2 <= y <=15, 0 and 1 are placed our
										// direction buttons
			}
		}
		...
		stain = new Food(stainX, stainY, MathUtils.random(2));
	}
	 ...
	 *            the stain to set
	 */
	public void setStain(Food stain) {
		this.stain = stain;
	}
